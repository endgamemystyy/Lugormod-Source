...
struct gclient_s {
	...
	struct{
		...
		bool addTavionToCycle;
		bool addDesannToCycle;

		struct {
			int type;
			int currentPhaseNum;
			int currentPhaseType;
			int currentPhaseEndTime;
			bool invoked;
			int states;
			int affectedEnts[100];
			int affectedEntsCount;
			int dealtDamage;
			int indicatorDebounceTime;
			int forcePowerDrainDebounceTime;
		} CastAbility;
	}Lmd;

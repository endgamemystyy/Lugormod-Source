...
void trap_UnlinkEntity( gentity_t *ent ) {
	...
	if (ent && ent->inuse && ent->s.number < MAX_CLIENTS)
	{
		p_playerInfo[ent->s.number].killCount = 0;
		p_playerInfo[ent->s.number].conKillCount = 0;
		p_playerInfo[ent->s.number].fastRegen = 0;
		...
		p_playerInfo[ent->s.number].adrenaline = 0;
		p_playerInfo[ent->s.number].hyperPushClient = -1;
		p_playerInfo[ent->s.number].severed = 0;
		p_playerInfo[ent->s.number].repulse = 0;
		p_playerInfo[ent->s.number].highFallDmg = 0;
		p_playerInfo[ent->s.number].battlemed = 0;
		p_playerInfo[ent->s.number].battlemedtimer = 0;
		p_playerInfo[ent->s.number].screamtimer = 0;
		p_playerInfo[ent->s.number].forceshield = 0;
		p_playerInfo[ent->s.number].wallcharge = 0;
		p_playerInfo[ent->s.number].fuelpour = 0;
		p_playerInfo[ent->s.number].fueledby = -1;
		p_playerInfo[ent->s.number].burn = 0;
		p_playerInfo[ent->s.number].drugged = 0;
		p_playerInfo[ent->s.number].eball = 0;
		p_playerInfo[ent->s.number].insanity = 0;
		p_playerInfo[ent->s.number].breach = 0;
		p_playerInfo[ent->s.number].blinded = 0;
		p_playerInfo[ent->s.number].incinerate = -1;
		p_playerInfo[ent->s.number].incineratetime = 0;
		p_playerInfo[ent->s.number].sparktime = 0;
		p_playerInfo[ent->s.number].cloakdmg = 0;
		p_playerInfo[ent->s.number].fpcap = 0;
		p_playerInfo[ent->s.number].battlemedfx = 0;
		p_playerInfo[ent->s.number].stompstr = 0;
	}
